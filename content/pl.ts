...
const raw = {
  ...
  chatUi: {
    ...
    legacyName: "Bot v1.2",
    inputPlaceholder: "Napisz wiadomość…",
    receiptAria: "Wiadomość wyświetlona przez Magdę",
    deliveredAria: "Wiadomość dostarczona",
  ...
  pillars: {
    ...
    demo: {
      ...
      reco: {
        ...
        products: [
          { name: "Kask MTB Core", price: "189 zł", kind: "kask" as const, fit: 5, priceVal: 189, margin: 5 },
          { name: "Buty trailowe X-Trail", price: "379 zł", kind: "but" as const, fit: 4, priceVal: 379, margin: 3 },
          { name: "Kurtka 3L Shell", price: "449 zł", kind: "kurtka" as const, fit: 3, priceVal: 449, margin: 4 },
          { name: "Komplet termoaktywny", price: "99 zł", kind: "odziez" as const, fit: 2, priceVal: 99, margin: 2 },
        ],
      },
    },
  },
