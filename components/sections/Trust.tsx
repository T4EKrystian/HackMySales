          ...
          <div className="flex flex-col divide-y divide-[var(--border-hairline)] rounded-[var(--radius-xl)] border border-hairline bg-card">
            ...
            <div className="js-reveal p-6">
              <div className="flex items-center justify-between gap-4">
                <p className="font-display text-base font-semibold tracking-tight text-ink">
                  {noInvent.title}
                  <span className="num ml-3 rounded-full border border-hairline px-2.5 py-1 t-meta uppercase tracking-[0.08em] text-mute">
                    {p.inventOff}
                  </span>
                </p>
                <div ref={lockRef}>
            ...
            <div className="js-reveal p-6">
              <div className="flex items-center justify-between gap-4">
                ...
                <span className="num rounded-full bg-blue-tint px-3 py-1.5 t-meta text-blue-deep">{p.rodoBadge}</span>
              </div>
